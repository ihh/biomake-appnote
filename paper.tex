...
\revision{A natural future direction would be to develop \biomake\ for highly parallel virtualized environments, complementing its current cluster-oriented batch-processing approach to parallelism.}
